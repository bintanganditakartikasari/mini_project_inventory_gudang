                      ...
                      Row(
                        children: [
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Nama Produk \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t: ${dataMayumi.mayumi[index].nama}', style: GoogleFonts.poppins(fontSize: 13)),
                              Text('Berat Produk \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t: ${dataMayumi.mayumi[index].berat} gr', style: GoogleFonts.poppins(fontSize: 13)),
                              Text('Jumlah Produk \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t: ${dataMayumi.mayumi[index].jumlah} pcs', style: GoogleFonts.poppins(fontSize: 13)),
                              Text('Tanggal Produksi Produk  : ${dataMayumi.mayumi[index].tanggalProduksi}', style: GoogleFonts.poppins(fontSize: 13)),
                              Text('Tanggal Expired Produk \t\t\t: ${dataMayumi.mayumi[index].tanggalExpired}', style: GoogleFonts.poppins(fontSize: 13)),
                            ],
                          ),
                        ],
                      ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Center(
                                                  ...
                                                  child: Text('Apakah anda yakin akan menghapus ${dataMayumi.mayumi[index].nama}?', style: GoogleFonts.poppins(fontSize: 15)),
                                                ),
                                                const SizedBox(
                                                  height: 10,
                                                ),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: (){
                                    namaController.text = dataMayumi.mayumi[index].nama.toString();
                                    beratController.text = dataMayumi.mayumi[index].berat.toString();
                                    jumlahController.text = dataMayumi.mayumi[index].jumlah.toString();
                                    produksiController.text = dataMayumi.mayumi[index].tanggalProduksi.toString();
                                    expiredController.text = dataMayumi.mayumi[index].tanggalExpired.toString();
                                    showDialog(
                                      context: context, 
                                      builder: (context) {
                                        return Dialog(
